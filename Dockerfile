...
RUN download-mibs
RUN curl https://docs.paloaltonetworks.com/content/dam/techdocs/en_US/zip/snmp-mib/pan-${PANOSVERSION}-snmp-mib-modules.zip > pan-${PANOSVERSION}-snmp-mib-modules.zip
